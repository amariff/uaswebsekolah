							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_about">
									<div class="footer_logo_container">
										<a href="#">
											<div class="footer_logo_text">SMAN 1 <span>Padang</span></div>
										</a>
									</div>
									<div class="footer_about_text">
										<p><h4>Social Media Kita</h4></p>
									</div>
									<div class="footer_social">
										<ul>
											<li><a href="https://www.facebook.com/"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
											<li><a href="https://www.instagram.com/amarif31/"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_contact">
									...
									<div class="footer_contact_info">
										<ul>
											<li>Email: AmalulR31@gmail.com</li>
											<li>Phone:  +(62)812-1039-3652</li>
											<li>Indonesia, Bekasi, Bekasi Utara</li>
										</ul>
									</div>
								</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made By <a href="https://www.instagram.com/amarif31/" target="_blank">Amalul Rifqi</a>
